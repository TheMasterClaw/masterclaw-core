...
This project is indexed by GitNexus as **workspace** (17572 symbols, 45303 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
